...
if (!nome) return res.json({ status : false, msg : "Está faltando o parametro nome."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/nome?token=@TeddyModz&nome=${nome}`))
...
if (!nome) return res.json({ status : false, msg : "Está faltando o parametro nome."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/nome2?token=@TeddyModz&nome=${nome}`))
    .then(response => response.json())
        .then(hasil => {
...
if (!cpf) return res.json({ status : false, msg: "Está faltando o parametro cpf."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/cpf?token=@TeddyModz&cpf=${cpf}`))
    .then(response => response.json())
        .then(hasil => {
...
if(!token)return res.json({status:false,msg:'Está faltando o parametro token.'})
 ...
 if (!cpf) return res.json({ status : false, msg: "Está faltando o parametro cpf."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/cpf2?token=@TeddyModz&cpf=${cpf}`))
    .then(response => response.json())
        .then(hasil => {
...
if(!token)return res.json({status:false,msg:'Está faltando o parametro token.'})
 ...
 if (!cpf) return res.json({ status : false, msg: "Está faltando o parametro cpf."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/cpf3?token=@TeddyModz&cpf=${cpf}`))
    .then(response => response.json())
        .then(hasil => {
...
if(!token)return res.json({status:false,msg:'Está faltando o parametro token.'})
 ...
 if (!cpf) return res.json({ status : false, msg: "Está faltando o parametro cpf."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/cpf4?token=@TeddyModz&cpf=${cpf}`))
    .then(response => response.json())
        .then(hasil => {
...
if(!token)return res.json({status:false,msg:'Está faltando o parametro token.'})
 ...
 if (!cpf) return res.json({ status : false, msg: "Está faltando o parametro cpf."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/cpf5?token=@TeddyModz&cpf=${cpf}`))
    .then(response => response.json())
        .then(hasil => {
...
if(!token)return res.json({status:false,msg:'Está faltando o parametro token.'})
 ...
 if (!cpf) return res.json({ status : false, msg: "Está faltando o parametro cpf."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/cpf6?token=@TeddyModz&cpf=${cpf}`))
    .then(response => response.json())
        .then(hasil => {
...
if(!token)return res.json({status:false,msg:'Está faltando o parametro token.'})
 ...
 if (!cpf) return res.json({ status : false, msg: "Está faltando o parametro cpf."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/cpf7?token=@TeddyModz&cpf=${cpf}`))
    .then(response => response.json())
        .then(hasil => {
...
if(!token)return res.json({status:false,msg:'Está faltando o parametro token.'})
 ...
 if (!cpf) return res.json({ status : false, msg: "Está faltando o parametro cpf."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/cpf8?token=@TeddyModz&cpf=${cpf}`))
    .then(response => response.json())
        .then(hasil => {
...
if(!token)return res.json({status:false,msg:'Está faltando o parametro token.'})
 ...
 if (!cpf) return res.json({ status : false, msg: "Está faltando o parametro cpf."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/score?token=@TeddyModz&cpf=${cpf}`))
    .then(response => response.json())
        .then(hasil => {
...
if(!token)return res.json({status:false,msg:'Está faltando o parametro token.'})
 ...
 if (!cpf) return res.json({ status : false, msg: "Está faltando o parametro cpf."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/vizinhos?token=@TeddyModz&cpf==${cpf}`))
    .then(response => response.json())
        .then(hasil => {
...
if(!token)return res.json({status:false,msg:'Está faltando o parametro token.'})
 ...
 if (!cpf) return res.json({ status : false, msg: "Está faltando o parametro cpf."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/parentes?token=@TeddyModz&cpf=${cpf}`))
    .then(response => response.json())
        .then(hasil => {
...
if(!token)return res.json({status:false,msg:'Está faltando o parametro token.'})
 ...
 if (!cpf) return res.json({ status : false, msg: "Está faltando o parametro cpf."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/beneficios?token=@TeddyModz&cpf=${cpf}`))
    .then(response => response.json())
        .then(hasil => {
...
if (!telefone) return res.json({ status : false, msg: "Está faltando o parametro telefone."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/tel?token=@TeddyModz&telefone=${telefone}`))
    .then(response => response.json())
        .then(hasil => {
...
if (!telefone) return res.json({ status : false, msg: "Está faltando o parametro telefone."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/tel2?token=@TeddyModz&telefone=${telefone}`))
    .then(response => response.json())
        .then(hasil => {
...
if (!telefone) return res.json({ status : false, msg: "Está faltando o parametro telefone."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/tel3?token=@TeddyModz&telefone=${telefone}`))
    .then(response => response.json())
        .then(hasil => {
...
if (!cnpj) return res.json({ status : false, msg: "Está faltando o parametro cnpj."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/cnpj?token=@TeddyModz&cnpj=${cnpj}`))
    .then(response => response.json())
        .then(hasil => {
...
if (!cnpj) return res.json({ status : false, msg: "Está faltando o parametro cnpj."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/cnpj2?token=@TeddyModz&cnpj=${cnpj}`))
    .then(response => response.json())
        .then(hasil => {
...
if (!placa) return res.json({ status : false, msg : "Está faltando o parametro placa."}) 
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/placa?token=@TeddyModz&placa=${placa}`))
    .then(response => response.json())
        .then(hasil => {
...
if(!bin)return res.json({status:false, motivo:'Está faltando o parâmetro bin.'})
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/bin?token=@TeddyModz&bin=${bin}`))
    .then(response => response.json())
        .then(hasil => {
...
if(!code)return res.json({status:false, motivo:'Está faltando o parâmetro cep.'})
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/cep?token=@TeddyModz&code=${code}`))
    .then(response => response.json())
        .then(hasil => {
        var resultado = hasil.result;
             res.json({
...
if(!code)return res.json({status:false, motivo:'Está faltando o parâmetro code.'})
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/banco?token=@TeddyModz&code=${code}`))        
    .then(response => response.json())
        .then(hasil => {
...
if(!code)return res.json({status:false, motivo:'Está faltando o parâmetro code.'})
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/ip?token=@TeddyModz&code=${code}`))        
    .then(response => response.json())
        .then(hasil => {
...
if(!code)return res.json({status:false, motivo:'Está faltando o parâmetro code.'})
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/ibge?token=@TeddyModz&code=${code}`))        
    .then(response => response.json())
        .then(hasil => {
...
if(!code)return res.json({status:false, motivo:'Está faltando o parâmetro code.'})
  if(tokenc.includes(token)){
    fetch(encodeURI(`https://japa-apis.herokuapp.com/puxar/cns?token=@TeddyModz&cns=${code}`))        
    .then(response => response.json())
        .then(hasil => {
